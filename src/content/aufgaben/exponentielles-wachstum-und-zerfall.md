...
- Wachstum um $p \,\%$ pro Zeitschritt → $q = 1 + \frac{p}{100}$. (5 % → q = 1,05)
- Zerfall um $p \,\%$ pro Zeitschritt → $q = 1 - \frac{p}{100}$. (5 % → q = 0,95)
...
| Nr. | $a$ | $q$ | $t$ | $f(t) = a\cdot q^t$ |
|----:|---|---|---|---|
| 9 | $1000$ | $1{,}10$ | $5$ | $\approx  1610{,}51$ |
| 10 | $1000$ | $1{,}10$ | $10$ | $\approx  2593{,}74$ |
| 11 | $1000$ | $1{,}05$ | $10$ | $\approx  1628{,}89$ |
| 12 | $1000$ | $0{,}90$ | $5$ | $\approx  590{,}49$ |
| 13 | $1000$ | $0{,}90$ | $10$ | $\approx  348{,}68$ |
| 14 | $500$ | $1{,}20$ | $4$ | $\approx  1036{,}80$ |
| 15 | $800$ | $0{,}75$ | $6$ | $\approx  142{,}38$ |
...
|----:|---|------|---|----------|----------------|
| 16 | $1000$ | $1500$ | $5$ | $q = (\frac{1500}{1000})^(\frac{1}{5}) \approx  1{,}084$ | ≈ 8,4 % Wachstum |
| 17 | $1000$ | $2000$ | $10$ | $q \approx  1{,}072$ | ≈ 7,2 % Wachstum |
| 18 | $1000$ | $500$ | $7$ | $q \approx  0{,}906$ | ≈ 9,4 % Zerfall |
| 19 | $200$ | $50$ | $4$ | $q \approx  0{,}707$ | ≈ 29,3 % Zerfall |
| 20 | $100$ | $1000$ | $5$ | $q \approx  1{,}585$ | ≈ 58,5 % Wachstum (sehr stark!) |
...
| 24 | Bei q = 0,90: Wann ist nur noch die Hälfte da? | $0{,}90^t = 0{,}5$ | $t = \log\frac{0{,}5}{\log}(0{,}90) \approx  6{,}6$ |
...
Hier wird die Funktion $f(t) = a \cdot  q^t$ numerisch geübt. Schüler sehen, dass der Bestand bei Wachstum *immer schneller* steigt und bei Zerfall *immer langsamer* fällt – das zentrale Charakteristikum exponentieller Vorgänge.
