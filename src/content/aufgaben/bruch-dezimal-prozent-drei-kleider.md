---
titel: "Bruch, Dezimalzahl, Prozent – dieselbe Zahl in drei Kleidern"
...
ziel: 'Die Schüler erleben Bruch, Dezimalzahl und Prozent als drei Schreibweisen derselben Zahl – nicht als drei Themen.'
variation: 'Folge A zeigt in jeder Zeile dieselbe Zahl dreimal. Folge B nimmt Nenner, die nicht glatt aufgehen, Folge C geht über 100 %, Folge D vergleicht quer über die Schreibweisen.'
...
regie:
  ...
  - 'Wer vergleicht 45 % und $\tfrac{2}{5}$, ohne zu rechnen?'
tags: ["brueche", "dezimalzahlen", "prozent", "darstellungswechsel", "anteil", "variation-theory"]
datum: 2026-08-28
entwurf: false
---
...
$\frac{1}{2}$, $0{,}5$ und $50 \,\%$ sind **dieselbe Zahl**. Sie sehen nur verschieden aus – wie derselbe Mensch in drei verschiedenen Jacken.

Die Übersetzungen:

- **Bruch → Dezimalzahl:** Zähler durch Nenner teilen. $\frac{3}{4} = 3 : 4 = 0{,}75$
- **Dezimalzahl → Prozent:** mit 100 multiplizieren. $0{,}75 = 75 \,\%$
- **Prozent → Bruch:** über 100 schreiben und kürzen. $75 \,\% = \frac{75}{100} = \frac{3}{4}$
...
Fülle die Lücken. In jeder Zeile steht dreimal derselbe Wert.

| Nr. | Bruch | Dezimalzahl | Prozent |
|----:|:------|:------------|:--------|
| 1 | $\frac{1}{2}$ | $0{,}5$ | $50 \,\%$ |
| 2 | $\frac{1}{4}$ | $0{,}25$ | $25 \,\%$ |
| 3 | $\frac{3}{4}$ | $0{,}75$ | $75 \,\%$ |
...
| Nr. | Bruch | Dezimalzahl | Prozent |
|----:|:------|:------------|:--------|
| 7 | $\frac{1}{8}$ | $0{,}125$ | $12{,}5 \,\%$ |
| 8 | $\frac{3}{8}$ | $0{,}375$ | $37{,}5 \,\%$ |
| 9 | $\frac{1}{20}$ | $0{,}05$ | $5 \,\%$ |
| 10 | $\frac{7}{20}$ | $0{,}35$ | $35 \,\%$ |
| 11 | $\frac{1}{3}$ | $0{,}333…$ | 33,3 % (gerundet) |
| 12 | $\frac{2}{3}$ | $0{,}666…$ | 66,7 % (gerundet) |
...
|----:|:------|:------------|:--------|
| 13 | $\frac{1}{1}$ | $1$ | $100 \,\%$ |
| 14 | $\frac{5}{4}$ | $1{,}25$ | $125 \,\%$ |
| 15 | $\frac{3}{2}$ | $1{,}5$ | $150 \,\%$ |
| 16 | $\frac{2}{1}$ | $2$ | $200 \,\%$ |
| 17 | $\frac{1}{1000}$ | $0{,}001$ | $0{,}1 \,\%$ |
| 18 | $\frac{0}{4}$ | $0$ | $0 \,\%$ |
...
| Nr. | Zahlen | Lösung |
|----:|:-------|:-------|
| 19 | $\frac{1}{2} \cdot  0{,}4 \cdot  45 \,\%$ | $0{,}4 < 45 \,\% < \frac{1}{2}$ |
| 20 | $\frac{2}{3} \cdot  0{,}6 \cdot  65 \,\%$ | $0{,}6 < 65 \,\% < \frac{2}{3}$ |
| 21 | $\frac{3}{8} \cdot  0{,}4 \cdot  35 \,\%$ | $35 \,\% < \frac{3}{8} < 0{,}4$ |
| 22 | $\frac{1}{4} \cdot  0{,}2 \cdot  30 \,\%$ | $0{,}2 < \frac{1}{4} < 30 \,\%$ |
| 23 | $\frac{7}{10} \cdot  0{,}07 \cdot  7 \,\%$ | $0{,}07 = 7 \,\% < \frac{7}{10}$ |
| 24 | $\frac{5}{4} \cdot  1{,}2 \cdot  130 \,\%$ | $1{,}2 < \frac{5}{4} < 130 \,\%$ |
...
1. Warum ist $0{,}5$ dasselbe wie $50 \,\%$, aber nicht dasselbe wie $0{,}5 \,\%$?
...
4. Welche Schreibweise würde wählen, um „ein Drittel" möglichst genau anzugeben?
5. Nenne drei Stellen aus dem Alltag, an denen Prozentangaben vorkommen. Welcher Grundwert ist dort jeweils gemeint?

## Didaktischer Kommentar

**Der Kern.** Der Darstellungswechsel ist keine Rechentechnik, sondern eine Frage der Zahlvorstellung. Wer $\frac{3}{4}$ und $0{,}75$ als zwei Dinge erlebt, hat den Zahlbegriff noch nicht aufgebaut – und wird bei jeder Textaufgabe scheitern, in der die Angaben gemischt vorkommen. Genau das ist im Alltag der Normalfall.
...
- *Bruchstrich nicht als Division gelesen.* $\frac{3}{8}$ wird zu $0{,}38$. Gegenmittel: Nr. 7 und 8 gemeinsam rechnen, den Taschenrechner ausdrücklich als Prüfmittel einsetzen.
- *Prozentzeichen ohne Umrechnung angehängt.* $0{,}04$ wird zu $0{,}04 \,\%$. Gegenmittel: Die Frage „Von hundert wie vielen?" vor jede Umrechnung setzen.
...
- [Werkzeug: Bruchstreifen](/werkzeuge/bruchstreifen.html) – Bruch, Prozentwert und Dezimalzahl werden gleichzeitig angezeigt
- [Übungsgenerator Bruch/Dezimal/Prozent](/uebung/bruch-dezimal-prozent)
- [Diagnostische Fragen zum Darstellungswechsel](/quizzes)
