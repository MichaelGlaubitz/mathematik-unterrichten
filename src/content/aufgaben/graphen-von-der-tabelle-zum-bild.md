---
titel: "Graphen – von der Tabelle zum Bild und zurück"
thema: "Graphen"
klassenstufe: ["8", "9"]
schwierigkeit: einsteiger
didaktischerHinweis: "Bevor Funktionstypen besprochen werden, muss das Koordinatensystem selbst sitzen. Diese Folge übt in beide Richtungen: aus dem Term ein Bild und aus dem Bild einen Term. Folge C ist der didaktische Kern – dieselbe Funktion in drei verschiedenen Achsenskalierungen. Erst wenn die Klasse gesehen hat, dass ein Graph beliebig steil aussehen kann, versteht sie, warum die Steigung eine Zahl und kein optischer Eindruck ist."
ziel: 'Die Schüler wechseln sicher zwischen Term, Tabelle und Bild – in beide Richtungen.'
variation: 'Folge C ist der Kern: dieselbe Funktion, aber andere Achsenskalierung. Das Bild ändert sich, die Funktion nicht.'
stolperstelle: '$x$- und $y$-Koordinate werden vertauscht; Kurven werden mit dem Lineal als Streckenzug gezeichnet.'
regie:
...
tags: ["graphen", "koordinatensystem", "steigung", "achsenskalierung", "funktionen", "variation-theory"]
datum: 2026-08-28
entwurf: false
---
...
| Nr. | Punkt | Lage |
|----:|:------|:-----|
| 1 | $A(3 \mid  2)$ | rechts oben |
| 2 | $B(2 \mid  3)$ | rechts oben, aber nicht A |
| 3 | $C(-3 \mid  2)$ | links oben |
| 4 | $D(3 \mid  -2)$ | rechts unten |
| 5 | $E(0 \mid  4)$ | auf der y-Achse |
| 6 | $F(4 \mid  0)$ | auf der x-Achse |
...
Erstelle zu jedem Term eine Wertetabelle für $x = -2, -1, 0, 1, 2$ und zeichne den Graphen.
...
| 12 |  $y = x^{2}$  | $0$ | – | Parabel, keine Gerade |
...
Zeichne sechsmal den Graphen von $y = 2x$ – jedes Mal mit anderer Skalierung.
...
| 24 | (1 \| 1) und (4 \| 3) | $\frac{2}{3}$ | $\frac{1}{3}$ |  $y = (\frac{2}{3})x + \frac{1}{3}$  |

*Hinweis zu Nr. 22 und 24:* Der y-Achsenabschnitt lässt sich hier nicht ablesen – bestimme erst $m$, setze dann einen Punkt ein.
...
**Was variiert in Folge C?** Ausschließlich die Skalierung – die Funktion bleibt identisch. Diese Folge ist am wirksamsten, wenn die Klasse die sechs Bilder tatsächlich zeichnet und nebeneinanderlegt. Digital geht es schneller: Im [Funktionenplotter](/werkzeuge/funktionenplotter.html) genügt Zoomen in einer Richtung.
...
- [Werkzeug: Funktionenplotter](/werkzeuge/funktionenplotter.html) – Parameter am Schieberegler, Spur für den Vergleich
- [Papier-Werkstatt](/werkzeuge/karopapier.html) – vorbereitete Koordinatensysteme, mehrere pro Blatt
- [Diagnostische Fragen zu Graphen](/quizzes)
