...
Die Steigung wird oft als „Steigungsdreieck" gelesen: `m = Δy / Δx` – wie viel der y-Wert *pro* x-Einheit zunimmt. Wenn m > 0, geht der Graph nach rechts oben; wenn m < 0, nach rechts unten; wenn m = 0, ist der Graph waagerecht.
...
|----:|:---------|:---------|:----------------|:----------------|
| 6 | y = 0 · x + 1 = 1 | 0 | (0, 1) | (1, 1) |
| 7 | y = 1 · x + 1 | 1 | (0, 1) | (1, 2) |
| 8 | y = 2 · x + 1 | 2 | (0, 1) | (1, 3) |
| 9 | y = (1/2) · x + 1 | 0,5 | (0, 1) | (1, 1,5) |
| 10 | y = −1 · x + 1 | −1 | (0, 1) | (1, 0) |
| 11 | y = −2 · x + 1 | −2 | (0, 1) | (1, −1) |
...
|----:|:---------|:-------|:------|:------|:------|
| 12 | y = 3x − 1 | −7 | −1 | 2 | 14 |
| 13 | y = (1/2)x + 4 | 3 | 4 | 4,5 | 6,5 |
| 14 | y = −2x + 6 | 10 | 6 | 4 | −4 |
| 15 | y = 0,1x + 100 | 99,8 | 100 | 100,1 | 100,5 |
...
| 17 | Schnittpunkt mit y-Achse bei (0, −1); pro 2 nach rechts geht es 1 nach oben | 1/2 | −1 | y = (1/2)x − 1 |
| 18 | Schnittpunkt mit y-Achse bei (0, 5); pro 1 nach rechts geht es 2 nach unten | −2 | 5 | y = −2x + 5 |
| 19 | Schnittpunkt mit y-Achse bei (0, 0); pro 4 nach rechts geht es 3 nach oben | 3/4 | 0 | y = (3/4)x |
| 20 | Gerade waagerecht durch (0, 3) | 0 | 3 | y = 3 |

## Folge E: Aus zwei Punkten die Gleichung berechnen

Hier wird die Steigung als Verhältnis berechnet: `m = (y₂ − y₁) / (x₂ − x₁)`.

| Nr. | Punkt A | Punkt B | Steigung m | y-Achsenabschnitt b | Funktionsgleichung |
|----:|:--------|:--------|:-----------|:--------------------|:-------------------|
| 21 | (0, 1) | (1, 3) | (3−1)/(1−0) = 2 | 1 (direkt aus Punkt A ablesbar) | y = 2x + 1 |
| 22 | (0, 4) | (2, 0) | (0−4)/(2−0) = −2 | 4 | y = −2x + 4 |
| 23 | (1, 5) | (3, 11) | (11−5)/(3−1) = 3 | 5 − 3·1 = 2 | y = 3x + 2 |
| 24 | (−2, 1) | (4, 4) | (4−1)/(4−(−2)) = 3/6 = 1/2 | 1 − (1/2)·(−2) = 1 + 1 = 2 | y = (1/2)x + 2 |
| 25 | (2, 7) | (5, 1) | (1−7)/(5−2) = −2 | 7 − (−2)·2 = 11 | y = −2x + 11 |
...
| 27 | Eine Kerze ist 20 cm hoch und brennt 0,5 cm pro Stunde ab. Wie hoch ist sie nach x Stunden? | −0,5 | 20 | y = −0,5x + 20 |
...
**Der Kern.** Lineare Funktionen sind ein Schlüsselthema in Klasse 8 – nicht nur als eigenständiger Stoff, sondern als Grundlage für *jede spätere Funktionsbetrachtung*. Wer die Parameter `m` und `b` als bedeutungstragende Größen versteht (und nicht nur als „Buchstaben in der Formel"), hat die richtige Vorstellung für quadratische Funktionen (`y = a·x² + b·x + c`), Exponentialfunktionen (`y = a · q^x`) und alles, was später kommt.
...
- *„Die Steigung ist die Höhe des Steigungsdreiecks."* Falsch. Die Steigung ist das *Verhältnis* `Höhe / Breite`. Wer das verwechselt, kann eine Bruchsteigung wie 1/2 nicht von einer ganzzahligen Steigung wie 2 unterscheiden.
...
- *„m und b kann man aus jeder Gleichungsform direkt ablesen."* Nur aus der *expliziten Form* `y = m·x + b`. Steht die Gleichung etwa als `2x + 3y = 6`, muss sie erst umgeformt werden.
