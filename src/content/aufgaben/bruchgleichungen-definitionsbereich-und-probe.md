...
ziel: 'Die Schüler bestimmen zuerst den Definitionsbereich und machen zuletzt die Probe – weil eine formal richtige Rechnung hier zu einer falschen Lösung führen kann.'
variation: 'Folge A bestimmt nur den Definitionsbereich, ohne zu rechnen. Erst danach kommen Gleichungen; Folge D bringt Scheinlösungen, die durch die Probe fallen.'
...
| 3 |  $\frac{3}{x+5} = 6$  | $x = -5$ |
| 4 |  $\frac{3}{2x-6} = 1$  | $x = 3$ |
| 5 |  $\frac{1}{x} + \frac{1}{x-1} = 3$  | x = 0 und x = 1 |
| 6 |  $\frac{1}{x^{2}-4} = 5$  | x = 2 und x = −2 |
...
| Nr. | Gleichung | Definitionsbereich | Lösung |
|----:|:----------|:-------------------|:-------|
| 13 |  $\frac{1}{x} = \frac{2}{x+3}$  | $x \neq  0, x \neq  -3$ | $x = 3$ |
| 14 |  $\frac{2}{x} = \frac{3}{x+1}$  | $x \neq  0, x \neq  -1$ | $x = 2$ |
| 15 |  $\frac{1}{x-1} = \frac{2}{x+1}$  | $x \neq  1, x \neq  -1$ | $x = 3$ |
| 16 |  $\frac{1}{x} + \frac{1}{2x} = 3$  | $x \neq  0$ | $x = 0{,}5$ |
...
|----:|:----------|:------------|:------------|
| 19 |  $\frac{x}{x-2} = \frac{2}{x-2}$  | $x = 2$ | keine Lösung (x = 2 verboten) |
| 20 |  $\frac{1}{x-3} = 0$  | – | keine Lösung: ein Bruch mit Zähler 1 wird nie null |
| 21 |  $\frac{x}{x-1} - \frac{1}{x-1} = 0$  | $x = 1$ | keine Lösung (x = 1 verboten) |
| 22 |  $\frac{x^{2}-9}{x-3} = 6$  | $x = 3$ | keine Lösung (x = 3 verboten) |
| 23 |  $\frac{1}{x+2} = \frac{1}{x+2}$  | jedes x | alle x außer x = −2 |
| 24 |  $\frac{3}{x-4} + \frac{12}{x-4} = 5$  | $x = 7$ | x = 7 ist gültig |
...
|----:|:--------|:------------------|
| 25 | Eine Zahl und ihr Kehrwert ergeben zusammen 2,5. Welche Zahl? |  $x + \frac{1}{x} = 2{,}5$  →  $x = 2$  oder  $x = 0{,}5$ . |
| 26 | Zwei Rohre füllen ein Becken zusammen in 6 Stunden. Rohr A allein braucht 10 Stunden. Wie lange braucht B allein? |  $\frac{1}{10} + \frac{1}{x} = \frac{1}{6}$  → x = 15 Stunden. |
| 27 | Ein Bruch hat den Zähler 3. Vergrößert man den Nenner um 2, halbiert sich der Wert. Wie heißt der Bruch? |  $\frac{3}{n} : 2 = \frac{3}{n+2}$  → n = 2, also  $\frac{3}{2}$ . |
| 28 | Bei welcher Zahl ist der Kehrwert viermal so groß wie die Zahl selbst? |  $\frac{1}{x} = 4x$  →  $x = 0{,}5$  oder  $x = -0{,}5$ . |
| 29 | Zwei Arbeiter brauchen zusammen 4 Stunden. Einer allein braucht 6 Stunden. Wie lange braucht der andere? |  $\frac{1}{6} + \frac{1}{x} = \frac{1}{4}$  → x = 12 Stunden. |
| 30 | Der Kehrwert einer Zahl, um 1 vergrößert, ergibt 3. Welche Zahl? |  $\frac{1}{x} + 1 = 3$  →  $x = 0{,}5$ . |
