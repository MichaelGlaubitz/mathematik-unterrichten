---
titel: "Negative Zahlen – die drei Bedeutungen des Minuszeichens"
...
tags: ["negative-zahlen", "vorzeichen", "zahlenstrahl", "variation-theory", "grundvorstellungen"]
datum: 2026-08-28
entwurf: false
---
...
*Frage nach Nr. 12:* Die zweite Zahl wird von Zeile zu Zeile kleiner. Was macht das Ergebnis? Und warum muss deshalb `6 − (−3)` größer als 6 sein?
...
*Frage nach Nr. 30:* In beiden Tabellen ändert sich das Ergebnis von Zeile zu Zeile um denselben Betrag. In welche Richtung – und warum muss deshalb `(−3) · (−2)` positiv sein?
...
*Hinweis zu Nr. 34:* Punkt vor Strich gilt auch mit Vorzeichen. Erst `(−3) · 2 = −6`, dann `7 − (−6) = 13`.
...
- *„Vor der Klammer verschwindet das Minus."* `−(3 − 7)` wird zu `−3 − 7`. Aufgabe 36 deckt es auf. Gegenmittel: Das Minus als `(−1) ·` schreiben und ausmultiplizieren – aus einer Vorzeichenregel wird das Distributivgesetz.
