---
title: "Dreißig Antworten statt zwei"
untertitel: "Mini-Whiteboards sind die wirksamste Anschaffung, die eine Fachschaft machen kann"
autor: "Dr. Michael Glaubitz"
datum: 2026-08-28
tags: ["mini-whiteboards", "formatives-assessment", "diagnose", "hinge-questions", "beteiligung"]
kategorie: "Werkzeug"
teaser: "Im normalen Unterrichtsgespräch antworten pro Frage ein bis zwei Personen. Die restlichen achtundzwanzig bleiben unsichtbar – für die Lehrkraft und oft auch für sich selbst. Eine laminierte A4-Folie für vierzig Cent ändert das."
entwurf: false
---
...
Genau diese Auswertung nimmt Ihnen der [Whiteboard-Check](/werkzeuge/whiteboard-check.html) ab: Sie zählen die Reihen durch und tippen dabei mit — `R` richtig, `H` halb, `F` falsch, `N` nichts —, und Quote und Ampel stehen sofort da. Die Erfassung ist bewusst anonym; es wird gezählt, nie zugeordnet. Nach drei Runden steht ein Klassenbild da, aus dem hervorgeht, welche Frage gehakt hat.
...
**Weiterlesen:** [Methode: Mini-Whiteboards](/methoden#mini-whiteboards) · [Hinge Questions](/blog/hinge-questions) · [Diagnostische Fragen zum Ausprobieren](/quizzes)
