...
kurz: "0,25, ein Viertel und 25 % sind nicht drei verwandte Zahlen, sondern eine einzige. Wer das nicht sieht, rechnet jede Aufgabe dreimal neu."
voraussetzungen:
...
einstiegsfrage:
  frage: "Welche dieser vier Zahlen ist am größten: 0,75 · drei Viertel · 75 % · 6/8?"
  antworten:
    - text: "Alle vier sind gleich groß."
      korrekt: true
      deutung: "Trägt. Nachfragen, wie geprüft wurde: umgerechnet oder erkannt? Beides ist richtig, aber nur das Erkennen spart in der Klassenarbeit Zeit."
    - text: "75 %, weil 75 die größte Zahl ist."
      korrekt: false
      deutung: "Die Prozentangabe wird als absolute Zahl gelesen. Häufig und hartnäckig – sie erklärt auch, warum Prozentaufgaben später scheitern."
    - text: "6/8, weil da die größten Zahlen stehen."
      korrekt: false
      deutung: "Der Bruch wird als Zahlenpaar gelesen statt als eine Größe. Dieselbe Fehlvorstellung, die bei der Bruchaddition zu 2/5 führt."
    - text: "0,75, weil Dezimalzahlen genauer sind."
      korrekt: false
      deutung: "Eine Aussage über die Schreibweise wird zu einer Aussage über die Zahl. Genauigkeit und Größe werden verwechselt."
  quiz: "bruch-dezimal-prozent-umwandeln"
phasen:
  - schritt: "K"
    minute: 0
    dauer: 8
    titel: "Vier Karten, eine Zahl"
    ablauf: "An der Tafel: 0,75 · drei Viertel · 75 % · 6/8. Die Einstiegsfrage steht darunter, alle antworten gleichzeitig."
  ...
  - schritt: "L"
    minute: 8
    dauer: 14
    titel: "Kärtchen sortieren"
    ablauf: "Gruppenarbeit mit vierzehn Kärtchen (siehe unten): Sie werden zu Vierergruppen zusammengelegt, in denen alle Karten dieselbe Zahl zeigen. Zwei Karten passen zu keiner Gruppe."
  ...
  - schritt: "A"
    minute: 22
    dauer: 14
    titel: "Auf einer Zahlengeraden"
    ablauf: "Die drei gefundenen Gruppen werden auf einer einzigen Zahlengeraden eingetragen – alle drei Schreibweisen an derselben Stelle, übereinander. Die Ausreißer bekommen ihren eigenen Platz."
  ...
  - schritt: "R"
    minute: 36
    dauer: 5
    titel: "Umrechnen in beide Richtungen"
    ablauf: "Aus der Aufgabenfolge die Aufgaben, bei denen zu einer gegebenen Schreibweise die beiden anderen ergänzt werden."
    lehrkraft: "Auf die Richtung achten: Von der Dezimalzahl zum Bruch ist der schwierigere Weg und wird oft übersprungen."
    werkzeug: { text: "Aufgabenfolge: Drei Kleider", href: "/aufgaben/bruch-dezimal-prozent-drei-kleider" }
  - schritt: "R"
    minute: 41
    dauer: 4
    titel: "Exit-Ticket"
    ablauf: "Zwei Fragen: eine Umrechnung in beide Richtungen und ein Größenvergleich."
...
differenzierung:
  schneller: "Schreibe 1/3 als Dezimalzahl und als Prozentangabe. Was fällt auf? Danach: Welche Nenner ergeben eine abbrechende Dezimalzahl und welche nicht? (Nur Nenner, deren Primfaktoren 2 und 5 sind.)"
  langsamer: "Nur mit Vierteln und Zehnteln arbeiten. Die Kärtchen werden auf acht reduziert, es gibt keine Ausreißer."
stolpersteine:
  - fehlvorstellung: "Prozentangaben werden als absolute Zahlen gelesen (75 % ist größer als 0,75)."
    reaktion: "Beide auf derselben Zahlengeraden eintragen. Sie landen an derselben Stelle – das ist kein Argument, sondern eine Beobachtung."
  - fehlvorstellung: "Der Bruch wird als Zahlenpaar gelesen (6/8 ist größer als 3/4, weil 6 > 3)."
    reaktion: "Beide am Bruchstreifen abtragen. Die gefüllte Fläche ist gleich groß, obwohl die Zahlen verschieden sind."
  - fehlvorstellung: "Eine Schreibweise ist „genauer“ als die andere."
    reaktion: "1/3 als Dezimalzahl schreiben lassen. Hier ist der Bruch die exakte Schreibweise und die Dezimalzahl die gerundete – genau umgekehrt zur Erwartung."
hausaufgabe: "Aus der Aufgabenfolge die erste Folge vollständig. Zusätzlich: Schreibe drei Zahlen auf, die du im Alltag gesehen hast (Rabatt, Anteil, Angabe auf einer Verpackung), und gib jede in allen drei Schreibweisen an."
tags: ["bruch-dezimal-prozent", "darstellungswechsel", "zahlenstrahl", "klar", "einzelstunde"]
datum: 2026-08-28
entwurf: false
---
...
- [Aufgabenfolge: Bruch, Dezimalzahl, Prozent – drei Kleider](/aufgaben/bruch-dezimal-prozent-drei-kleider)
- [Diagnostische Fragen zum Umwandeln](/quizzes/bruch-dezimal-prozent-umwandeln)
- [Werkzeug: Bruchstreifen](/werkzeuge/bruchstreifen.html)
- [Stundenverlauf: Was ist eigentlich das Ganze?](/stunden/prozentrechnung-was-ist-das-ganze) – der nächste Schritt
