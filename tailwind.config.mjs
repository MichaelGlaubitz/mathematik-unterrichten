  ...
  theme: {
    extend: {
      colors: {
        ...
        // Alias: "ink" wird in BaseLayout, DiagnosticQuiz und Markdown-Seiten als
        // neutrale Textfarbe verwendet. Spiegelt slate, ergaenzt um ink-0 (weiss).
        ink: {
          0: '#ffffff',
          50: '#f8fafc',
          100: '#f1f5f9',
        ...
        // Alias: "accent" wird fuer Buttons, Badges, Links und Hervorhebungen
        // verwendet. Spiegelt violet.
        accent: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
